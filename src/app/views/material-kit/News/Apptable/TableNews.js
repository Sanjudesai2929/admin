...
const UserData = () => {
    ...
    const deleteUser = async (rowId) => {
        await axios.post(`http://localhost:8000/deleteNews`, rowId)
        getData()
        setOpen(true)
    }
                        ...
                        {userData
                            ...
                            .map((subscriber, index) => (
                                ...
                                >
                                    ...
                                    <TableCell id="tablecell">
                                        {subscriber.newstitle}
                                    </TableCell>
                                    <TableCell id="tablecell">
                                        {subscriber.sdescription}
                                    </TableCell>
                                    <TableCell id="tablecell">
                                        {subscriber.date}
                                    </TableCell>
                                    ...
                                    <TableCell>
                                        <NavLink
                                            to={{
                                                pathname: `/material/updatenews/${subscriber._id}`,
                                            }}
                                        >
                                            <IconButton
                                                className="button"
